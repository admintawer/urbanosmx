...
class hr_payslip(models.Model):
    ...
    descuento1_amount = fields.Float('Monto descuento 1',compute='get_descuento1_amount', store=True)
    descuento1_int = fields.Float('Interés descuento 1',compute='get_descuento1_amount', store=True)
    descuento2_amount = fields.Float('Monto descuento 2',compute='get_descuento2_amount', store=True)
    descuento2_int = fields.Float('Interés descuento 2',compute='get_descuento2_amount', store=True)
    ...
    def get_descuento1_amount(self):
        for payslip in self:
            ...
            if payslip.installment_ids:
                ...
                payslip.descuento1_amount = 0.00
                payslip.descuento2_int = 0.00                
    ...
    def get_descuento2_amount(self):
        for payslip in self:
            ...
            if payslip.installment_ids:
                ...
                payslip.descuento2_amount = 0.00
                payslip.descuento2_int = 0.00
