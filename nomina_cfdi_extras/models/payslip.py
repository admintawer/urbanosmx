...
class Payslip(models.Model):
    ...
    def get_total_code_value(self,special_code):
        ...
        for line in line_ids:
            if line.salary_rule_id.category_id.code == 'ALW' or line.salary_rule_id.category_id.code == 'ALW3' or line.salary_rule_id.category_id.code == 'BASIC' or line.salary_rule_id.code == 'P010':
...
#                     result[line.code] = line.name
    ...
    def export_report_xlsx(self):
        ...
        #raise UserWarning(payslip_group_by_department)
        row = 1
        grand_total = {}
